...
LANGUAGES = {
    'en': {
        ...
        'ai_research_development': 'Research and Development',
        'ai_ethics_regulations': 'Ethics and Regulations',
        'ai_safety_governance': 'Safety and Governance',
        'ai_business_industry': 'Business and Industry',
        'ai_language_models_nlp': 'Language Models and NLP',
        'ai_robotics_automation': 'Robotics and Automation',
        'ai_healthcare_medical': 'Healthcare and Medical',
        'ai_education_training': 'Education and Training',
        'ai_cybersecurity_privacy': 'Cybersecurity and Privacy',
        'ai_computer_vision': 'Computer Vision',
        'ai_data_science_analytics': 'Data Science and Analytics',
        'ai_neural_networks_deep_learning': 'Neural Networks and Deep Learning',
        'ai_applications_deployment': 'Applications and Deployment',
        'ai_technology_infrastructure': 'Technology and Infrastructure',
